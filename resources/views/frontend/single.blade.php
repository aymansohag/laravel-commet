...
@section('main-content')
    <section class="page-title parallax">
      <div data-parallax="scroll" data-image-src="{{ URL::to('/')}}/media/posts/{{ $post -> featured_image }}" class="parallax-bg"></div>
      <div class="parallax-overlay">
        <div class="centrize">
          <div class="v-center">
            <div class="container">
              <div class="title center">
                <h1 class="upper">{{ $post -> title }}<span class="red-dot"></span></h1>
            ...
            <div id="comments">
              ...
              <ul class="comments-list">
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="frontend/assets/images/team/1.jpg" alt="" class="img-circle">
                    </div>
                  ...
                  <ul class="children">
                    <li>
                      <div class="comment">
                        <div class="comment-pic">
                          <img src="frontend/assets/images/team/2.jpg" alt="" class="img-circle">
                        </div>
                        <div class="comment-text">
                ...
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="frontend/assets/images/team/3.jpg" alt="" class="img-circle">
                    </div>
                    <div class="comment-text">
