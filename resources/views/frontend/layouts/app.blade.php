...
<!-- Mirrored from themes.hody.co/html/comet/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 06:31:24 GMT -->
<head>
  ...
  <body>
    ...
    <header id="topnav">
      <div class="container">
        ...
        <div class="logo">
          <a href="index.html">
            <img style="width: {{ $settings -> logo_width }}" src="media/settings/{{ $settings -> logo_name }}" alt="" class="logo-light">
            <img style="width: {{ $settings -> logo_width }}" src="frontend/assets/images/logo_dark.png" alt="" class="logo-dark">
          </a>
        </div>
        <!-- End Logo container-->
            ...
            <div class="col-md-4">
              <div class="footer-social">
                <ul>
                  ...
                  <li>
                    <a target="_blank" href="{{ $social_data -> ln }}"><i class="ti-linkedin"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $social_data -> in }}"><i class="ti-instagram"></i></a>
                  </li>
                  <li>
                    <a target="_blank" href="{{ $social_data -> drb }}"><i class="ti-dribbble"></i></a>
                  </li>
                </ul>
              </div>
            </div>
...
<!-- Mirrored from themes.hody.co/html/comet/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Mar 2021 06:34:00 GMT -->
</html>
